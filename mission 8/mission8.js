...
function f2(){
    let note_maths = 15;
    let note_français = 13;
    let note_ses = 17;
    let moyenne = (note_maths + note_français + note_ses)/3;
...
function f4(){
    let ht = prompt("Montat hors taxe");
    let ttc = ht * 1.2;
...
function f6(){
    ...
    let taux_tva_calcul = (taux_tva /100)+1;
    if(ttc > 100){
        document.body.innerHTML = '<h1 style="color: yellow">'+TTC+'</h1>';
    }
    else {
...
function f7(){
    ...
    document.getElementById('cocktail').innerText = 'Pina colada';
}
function f8(){
