...
namespace Locationmoto.Views
{
    ...
    public partial class ConnectionWindow : Window
    {
        ...
        private void ConnectButton_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                if (connectedUser != null && connectedUser.id != 0)
                {
                    ...
                    {
                        // Si l'utilisateur est un employé, ouvrir le tableau de bord de l'employé.
                    ...
                    {
                        // Si l'utilisateur est un client, ouvrir la fenêtre principale de LocationMoto.
        ...
        {
            // Ouvre la fenêtre principale en mode invité, sans connexion.
